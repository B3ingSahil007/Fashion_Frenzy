...
//Change URL for Carousel
export const bannerData = [
  { _id: 1, url: 'https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/Homepage-Banner_1_cjv4Kb8.jpg?format=webp&w=1500&dpr=1.3' },
  { _id: 2, url: 'https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/homepage_copy_PuO0FA6.jpg?format=webp&w=1500&dpr=1.3' },
  { _id: 3, url: 'https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/Homepage-Banner_sQwAZfH.jpg?format=webp&w=1500&dpr=1.3' },
  { _id: 4, url: 'https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/Homepage-Banner-2_GhHUqpf.jpg?format=webp&w=1500&dpr=1.3' },
  { _id: 5, url: 'https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/Homepage-Banner_W6ffboL.jpg?format=webp&w=1500&dpr=1.3' },
]