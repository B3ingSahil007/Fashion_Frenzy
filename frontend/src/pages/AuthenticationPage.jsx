        ...
        <>
            <Grid container component="main" sx={{ height: '100vh' }}>
                            ...
                            <Grid container>
                                <Grid>
                                    ...
                                    {mode === 'Login' && role === 'Seller' ? '' :
                                        (mode === 'Register' && role === 'Customer' ? 'Already have an account?' : "Don't have an account?")
                                    }
                ...
                <Grid
                    ...
                    md={7}
                    sx={{
                        backgroundImage: `url(${bgpic})`,backgroundRepeat: 'no-repeat',backgroundColor: (t) => t.palette.mode === 'light' ? t.palette.grey[50] : t.palette.grey[900],backgroundSize: 'cover',backgroundPosition: 'center',
                    }}
                />
            </Grid>
