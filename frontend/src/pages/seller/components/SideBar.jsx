        ...
        <>
            <React.Fragment>
                ...
                </ListItemButton>
                {
                    currentRole === "DMD" &&
                    <ListItemButton
                        component={Link} to="/Seller/DMD"
                        sx={location.pathname.startsWith('/Seller/DMD') ? styles.currentStyle : styles.normalStyle}
                    >
                        <ListItemIcon>
                            <AdminPanelSettingsIcon sx={{ color: location.pathname.startsWith("/Seller/DMD") ? '#4d1c9c' : 'inherit' }} />
                        </ListItemIcon>
                        <ListItemText primary="DMD" />
                    </ListItemButton>
                }
            </React.Fragment>
            <Divider sx={{ my: 1 }} />
